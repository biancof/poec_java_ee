<%@ page language="java" contentType="text/html; charset=ISO-8859-1" isELIgnored="false" pageEncoding="ISO-8859-1"%> <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%> 
				...
				<tbody> 
					<c:forEach items="${modification.listeCourses}" var="course" varStatus="status"> 
						<tr> 
							...
							<td>
								<input type="text" name="listeCourses[${status.index}].quantite" value="${course.quantite}"/><br/> <b><i>
								<form:errors path="listeCourses[${status.index}].quantite" /></i></b>
							</td> 
						</tr> 
					</c:forEach> 
				</tbody> 
